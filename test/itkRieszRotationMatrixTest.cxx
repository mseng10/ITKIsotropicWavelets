...
int compareImagesAndReport(
    typename TImage::Pointer validImage,
    typename TImage::Pointer testImage)
{
...
runRieszRotationMatrixInterfaceWithRieszFrequencyFilterBankGeneratorTest()
{
  ...
  // g(0, 0) = 0; g(0, 1) = 0;  g(0, 2) = 1;
  // result = 1.0 * images[2]
  int firstComponentStatus = compareImagesAndReport<ImageType>(
      images[2], imagesMultipliedByRieszRotationMatrix[0]);
  // Second
  // g(1, 0) = 0; g(1, 1) = -1; g(1, 2) = 0;
  // expectedresult = -1.0 * images[1]
  typename MultiplyImageFilterType::Pointer multiplyImageFilterInvert =
      MultiplyImageFilterType::New();
  ...
  int secondComponentStatus = compareImagesAndReport<ImageType>(
      images[1], multiplyImageFilterInvert->GetOutput());
  // Third
  // g(2, 0) = 1; g(2, 1) = 0;  g(2, 2) = 0;
  // result = 1.0 * images[0]
