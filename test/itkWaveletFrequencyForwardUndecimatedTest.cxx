...
itkWaveletFrequencyForwardUndecimatedTest( int argc, char *argv[] )
{
  ...
  using HeldForwardWaveletType = itk::WaveletFrequencyForwardUndecimated< ComplexImageType, ComplexImageType, HeldWaveletFilterBankType >;
  ...
  using VowForwardWaveletType = itk::WaveletFrequencyForwardUndecimated< ComplexImageType, ComplexImageType, VowWaveletFilterBankType >;
  ...
  using SimoncelliForwardWaveletType = itk::WaveletFrequencyForwardUndecimated< ComplexImageType, ComplexImageType, SimoncelliWaveletFilterBankType >;
  ...
  using ShannonForwardWaveletType = itk::WaveletFrequencyForwardUndecimated< ComplexImageType, ComplexImageType, ShannonWaveletFilterBankType >;
